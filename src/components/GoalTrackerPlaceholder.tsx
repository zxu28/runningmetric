...
const GoalTrackerPlaceholder: React.FC = () => {
  return (
    <motion.div
    ...
    >
      <div className="text-center">
        ...
        <h3 className="text-lg font-semibold text-gray-700 mb-2">Goal Tracker</h3>
        <p className="text-gray-500 text-sm mb-3">
          Set and track weekly/monthly running goals
        </p>
...
export default GoalTrackerPlaceholder
